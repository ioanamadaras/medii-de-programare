...
namespace MADARAS_IOANA_Lab2.Data
{
    public class MADARAS_IOANA_Lab2Context : DbContext
    {
        ...
        public DbSet<MADARAS_IOANA_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<MADARAS_IOANA_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<MADARAS_IOANA_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
